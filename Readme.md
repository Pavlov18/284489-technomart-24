...
* Студент: [Александр Павлов](https://up.htmlacademy.ru/htmlcss/24/user/284489).
* Наставник: `Кексобот`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/284489-technomart-24) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
